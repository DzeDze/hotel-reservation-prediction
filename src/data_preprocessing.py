...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            logger.info("Doing Skwewness Handling")
    ...
    def process(self):
        try:
            logger.info("Loading training and testing data from RAW directory")
            ...
            test_df = test_df[train_df.columns]  # Ensure test data has same features as train data
