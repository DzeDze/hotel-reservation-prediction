...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            logger.info("Successfully loaded and split the data for Model Training")
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            logger.info("Starting LightGBM model")
            ...
            logger.info("Hyperparameter tuning is completed")
